    ...
    class UserRepository {
        ...
        public function create(UserModel $user) {
            ...
            try {
                ...
                $query = "INSERT INTO users (username, email, password, phone, adress, name) VALUES (:username, :email, :password, :phone, :adress, :name)";
                ...
                $prepare->bindValue(":phone", $user->getPhone());
                $prepare->bindValue(":adress", $user->getAdress());
        ...
        public function update(UserModel $user) {
            ...
            $query = "UPDATE users SET username = :username, email = :email, password = :password, phone = :phone, adress = :adress, name = :name WHERE id = :id";
            $prepare = $this->conn->prepare($query);
            $prepare->bindValue(":username", $user->getUsername());
            $prepare->bindValue(":email", $user->getEmail());
            $prepare->bindValue(":password", $user->getPassword());
